...
## Project Structure
    ...
    ├── testapiautoconnect_116416  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_116416`
...
2. Clone this repo and `cd testapiautoconnect_116416`
